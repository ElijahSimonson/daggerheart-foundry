 ...
 * base daggerheart system folder.
 * @type {string}
 */
const PACK_DEST = "packs";

/**
 * Folder where source JSON files should be located relative to the daggerheart system folder.
 * @type {string}
 */
...
function cleanPackEntry(data, { clearSourceId=true, ownership=0 }={}) {
  ...
  if ( data._stats?.lastModifiedBy ) data._stats.lastModifiedBy = "daggerheartbuilder0000";
