# Contributing to ElijahSimonson\Daggerheart
...
Cloning this repository and either placing it in or symlinking it to your `Data/systems/daggerheart` user data directory is all that is necessary to run this within Foundry VTT. However, if you want to make changes to either the LESS stylesheets or the compendia, there are some developer tools which will make your life easier.
...
All Content released with this system must come from the Darrington Press [Daggerheart System Reference Document](https://www.daggerheart.com/wp-content/uploads/2025/05/DH-SRD-May202025.pdf) (aka SRD).
