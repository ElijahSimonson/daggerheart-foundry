 ...
 */
export default class CombatantDH extends Combatant {
  /**
  ...
  async createTurnMessage({ deltas, periods, rolls }={}) {
     ...
     * @function daggerheart.preCreateCombatMessage
     * @memberof hookEvents
     * @param {CombatantDH} combatant         Combatant for which the message will be created.
     ...
     */
    Hooks.callAll("daggerheart.preCreateCombatMessage", this, messageConfig);
  ...
  async recoverCombatUses(periods) {
     ...
     * @function daggerheart.preCombatRecovery
     * @memberof hookEvents
     * @param {CombatantDH} combatant  Combatant that is being recovered.
     ...
     */
    if ( Hooks.call("daggerheart.preCombatRecovery", this, periods) === false ) return;
     ...
     * @function daggerheart.combatRecovery
     * @memberof hookEvents
     * @param {CombatantDH} combatant          Combatant that is being recovered.
     ...
     */
    if ( Hooks.call("daggerheart.combatRecovery", this, periods, results) === false ) return;
     ...
     * @function daggerheart.postCombatRecovery
     * @memberof hookEvents
     * @param {CombatantDH} combatant       Combatant that is being recovered.
     * @param {string[]} periods            Periods that were recovered.
     * @param {ChatMessageDH|void} message  Chat message created, if any.
     */
    Hooks.callAll("daggerheart.postCombatRecovery", this, periods, message);
  }
