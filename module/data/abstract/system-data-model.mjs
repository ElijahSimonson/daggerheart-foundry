...
export default class SystemDataModel extends foundry.abstract.TypeDataModel {
    ...
    /**
     * System type that this system data model represents (eg. 'character', 'npc', 'vehicle'
     * @type {string}
     */
    static _systemType;
     ...
     * @property {typeof DataModel} [systemFlagsModel]  Model that represents flags data within the daggerheart namespace.
     */
    ...
    async _preCreate(data, options, user) {
        ...
        if ( actor.itemTypes[data.type]?.length ) {
            ui.notifications.error(game.i18n.format("DAGGERHEART.ActorWarningSingleton", {
