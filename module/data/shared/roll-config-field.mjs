    ...
    constructor({roll={}, ability="", ...fields}={}, options={}) {
        ...
        fields = {
            ability: (ability === false) ? null : new StringField({
                required: true,
                initial: ability,
                label: "DAGGERHEART.AbilityModifier"
            }),
            roll: new SchemaField({
                min: new NumberField({...opts, label: "DAGGERHEART.ROLL.Range.Minimum"}),
                max: new NumberField({...opts, label: "DAGGERHEART.ROLL.Range.Maximum"}),
